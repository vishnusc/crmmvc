	...
	<div align="center">
		...
		<form:form method="POST" modelAttribute="newcustomer">
			...
			<table cellpadding="6">
				...
				<tr>
					<td>Preference:</td>
					<td><form:radiobutton path="prefence" id="prefence"
							value="Food" /> Food &nbsp&nbsp <form:radiobutton path="prefence"
							id="prefence" value="Drinks" /> Drinks &nbsp&nbsp <form:radiobutton
							path="prefence" id="prefence" value="Both" /> Both</td>
				...
				<tr>
					...
					<td><form:radiobutton path="contactMode" id="contactMode"
							value="Phone" /> Phone &nbsp&nbsp <form:radiobutton
							path="contactMode" id="contactMode" value="Mail" /> Mail
						&nbsp&nbsp <form:radiobutton path="contactMode" id="contactMode"
							value="Both" /> Both</td>
				</tr>
				<tr>
					<td colspan="3">
					<c:choose>
						<c:when test="${edit}">
							<form:input type="hidden" path="vdate" id="vdate" value="${customer.vdate}" />
